...
export default function Footer() {
  return (
    <footer className="bg-[#0c0c0c] text-white w-full pt-8 pb-6 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between gap-6 md:gap-6 mb-4">
          ...
          <div className="w-full md:w-5/12 pr-0 md:pr-12">
            ...
            <p className="font-headline text-[11px] text-white/40 leading-relaxed max-w-sm">
          ...
          <div className="w-full md:w-7/12 grid grid-cols-2 lg:grid-cols-3 gap-8 md:justify-items-end">
            <div className="flex flex-col gap-4">
              <h4 className="font-headline font-bold text-white uppercase text-[10px] tracking-[0.25em]">Platform</h4>
            ...
            <div className="flex flex-col gap-4">
              <h4 className="font-headline font-bold text-white uppercase text-[10px] tracking-[0.25em]">Resources</h4>
              <nav className="flex flex-col gap-2">
            ...
            <div className="hidden lg:flex flex-col gap-4">
              <h4 className="font-headline font-bold text-white uppercase text-[10px] tracking-[0.25em]">Contact</h4>
              <nav className="flex flex-col gap-2">
                {[
